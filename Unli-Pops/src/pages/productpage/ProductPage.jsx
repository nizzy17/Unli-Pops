        ...
        <div className="productPage__right">
          <div className="productPage__right__">
            ...
            <div className="prod-price">
              <h1 className="productPage__right__price">{price}.00</h1>
            ...
            <div>
              ...
              <ul className="giveBullets">
                <li>
                  Applicable on: Orders above 500 (only on first purchase)
                </li>
                <li>
                  Coupon code: <b>UNLIPOPS69</b>
                </li>
                <li>Coupon Discount: 40% off (check cart for final savings)</li>
              </ul>

              <h2 className="sub_">View Eligible Products</h2>
              <br />
              <h1 className="product-details-heading">EMI option available</h1>
              <li className="bullets">EMI starting from 87/month</li>
